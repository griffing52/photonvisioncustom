 ...
 */
 ...
 public class CustomPipeline
         extends CVPipeline<CVPipelineResult, CustomPipelineSettings> {
    ...
    //  private static final FrameThresholdType PROCESSING_TYPE = FrameThresholdType.HSV;
     ...
     public CustomPipeline() {
         ...
         settings = new CustomPipelineSettings();
     }
 
     public CustomPipeline(CustomPipelineSettings settings) {
         super(PROCESSING_TYPE);
     ...
     @Override
     protected CVPipelineResult process(Frame frame, CustomPipelineSettings settings) {
